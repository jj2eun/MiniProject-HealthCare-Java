...
public class ExerciseList {
	...
	private void initialize() {
		...
		// }
		//
		// combo.setSelectedItem(today_year + "년" + today_month + "월" + today_day +
		// "일");
		//
		...
		try {
			ResultSet rs = db.getInfo(
					"SELECT Ex_no, User_ID, Exercise_Date, u.Exercise_no, Exercise_Name, Exercise_Cal, Exercise_Time "
			...
			while (rs.next()) {
				...
				Object data[] = { Ex_no, User_ID, Exercise_Date, Exercise_no, Exercise_Name, Exercise_Cal,
						Exercise_Time };
				model2.addRow(data);
